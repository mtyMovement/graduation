...
!function (c, r) {
    ...
    var I = c.fn.jquery.split("."), J = ~~I[0], K = ~~I[1];
    ...
    var T = window.jsModern, v = navigator.userAgent.toLowerCase(), x = {}, L = {};
    c("head");
    var E = c("html"), F = !!v.match("trident");
    c.event.special.tap = {
        setup: function () {
            var a = this, b = !1, f = 0;
                ...
                switch (b) {
                    case "animationBegin":
                        if (a && x[a]) {
                            ...
                            d.data({jsmodernAnimationRunning: !0, jsmodernAnimationName: x[a]});
                            f()
                        }
                        break;
                    case "animationPause":
    ...
    var w = {
        isMobile: function () {
            ...
            if ("boolean" === c.type(a) && a) {
                var f = v.indexOf("android"), f = v.substring(f + 7), e = f.indexOf(";");
            ...
            if (Array.isArray(a)) {
                if (Array.from) a = Array.from(new Set(a)); else {
                    for (var b = {}, f = [], e = 0, d = a.length; e < d; e++) {
                        var g = a[e], h = c.type(g);
            ...
            if (1 == e && "string" === c.type(a)) {
                var d = document.cookie.replace(/[=]/g, "; ").split("; "), g = "";
            ...
            (function g(h) {
                ...
                k.onload = function () {
                    var m;
                    m = this.width;
                    var l = this.height, n = h.substring(h.lastIndexOf(".") + 1).toLowerCase(),
            ...
            if (2 == arguments.length && c.isPlainObject(b)) {
                var e = c("body"), d = w.random(10, !1).toLowerCase();
                L[d] = b.event;
                c(a).each(function () {
                    var a = b.data, e = c(this).attr("jm-data");
                    e && (a = a[e.trim()]);
                    ...
                    e.find("[jm-for]").each(function () {
                        var b = c(this)[0].outerHTML,
                            d = c(this).attr("jm-for").replace(/\s+/g, " ").trim().split(" in "), e = d[0], d = a[d[1]];
                ...
                e.find("[jm-event]").each(function () {
                    var a = c(this).attr("data-event"), b = c(this).attr("jm-event");
            ...
            if (F) w[E.data("fullScreenIn") ? "fullScreenOut" : "fullScreenIn"](a); else w[document.fullScreen || document.webkitIsFullScreen || document.mozFullScreen || document.msFullScreen ? "fullScreenOut" : "fullScreenIn"](a);
            return this
        }, top: function (a, b) {
            var f, e;
            ...
            d.click(function () {
                c("html, body").stop().animate({scrollTop: 0}, f || 300)
            });
            return this
            ...
            c(a).each(function () {
                ...
                if (d > a.width()) {
                    ...
                    var e = a.find(".jsmodern-marquee-inner"), g = a.find(".jsmodern-marquee-default");
            ...
            var b = encodeURIComponent(location.href), f = document.title, e = null;
            c(document).on("click", function (d) {
                d = d || window.event;
                d = c(d.target);
                var g = v.match("firefox");
                if (d.is(a.qrcode)) {
                    if (e) c("body").append(e); else {
                        ...
                        var h = c("#jsmodern-share").find("section"), k = "jquery-qrcode-" + w.random(15, !1),
                ...
                d.is(a.douban) && function () {
                    var a = document, c = encodeURIComponent, d = window.getSelection, e = a.getSelection,
                        a = a.selection, d = d ? d() : e ? e() : a ? a.createRange().text : "",
            ...
            c(a).each(function () {
                function a(a) {
                    ...
                    "slide" === k && (t.is(":animated") || t.stop().animate({left: -(g * a + g) + "px"}, 700, "easeInOutQuart", function () {
                ...
                var d = c(this);
                d.find("a");
                var g = d.width(), h = d.height(), k = "slide", m = !0, l = !0, n = b.dotPosition || "center", p = !1;
                ...
                var t = d.find(".jsmodern-picture-inner"), q = d.find(".jsmodern-picture-part"), z = d.find("img, a"),
                    u = q.length;
                ...
                var z = d.find(".jsmodern-picture-dot"), A = z.find("b");
            ...
            c(a).each(function () {
                var a = c(this), d = a.find("video"), g = d[0], h = a.width(), k = a.height();
                if (w.isMobile()) d.attr("controls", "controls"), g.width = h, g.height = k, a.addClass("jsmodern-video"), d.on("ended", function () {
                    ...
                    var l = a.find(".jsmodern-video-panel"), n = l.find(".jsmodern-video-pass"),
                        a = l.find(".jsmodern-video-linebox"), p = l.find(".jsmodern-video-linedot"),
                        t = l.find(".jsmodern-video-play"), q = l.find(".jsmodern-video-volume"),
                        z = l.find(".jsmodern-video-volumebox"), u = l.find(".jsmodern-video-volumeline"),
                        A = l.find(".jsmodern-video-volumedot"), r = l.find(".jsmodern-video-start"),
                        v = l.find(".jsmodern-video-end"), y = l.find(".jsmodern-video-fullin"), x = a.width();
                    ...
                    p.on("mousedown", function (a) {
                        var b = c(this), d = c(this).parent().offset().left;
                    ...
                    A.on("mousedown", function (a) {
                        var b = c(this), d = b.parent().offset().left;
                        c(document).on("mousemove", function (a) {
                            a = a || window.event;
                            var c = a.pageX - d;
                            a.preventDefault();
                    ...
                    var N = screen.width, O = screen.height, P = function (a) {
                        a.webkitRequestFullScreen ? a.webkitRequestFullScreen() : a.mozRequestFullScreen ? a.mozRequestFullScreen() : a.msRequestFullscreen ? a.msRequestFullscreen() : a.requestFullScreen && a.requestFullScreen()
                    }, Q = function () {
            ...
            if (w.isMobile()) c(a).css({
                ...
                var a = c(this), e = a.children().first(), d = a.innerHeight(), g = e.outerHeight(!0),
                ...
                if (h > a.innerHeight()) {
                    ...
                    a.on("mousewheel DOMMouseScroll", function (a) {
                        ...
                        k.css({transform: "translate(0, " + a + "px)", transition: ".2s"}).data("cacheY", a);
                        e.css({transform: "translate(0, -" + h / d * a + "px)", transition: ".2s"})
                    })
                }
            }), this
        }, lazyload: function (a) {
            function b(a, b) {
                a.attr("src", b).on("load", function () {
                    a.stop().animate({opacity: a.data("lazyOpacity")}, 500, function () {
            ...
            if (b && c.isPlainObject(b)) {
                var f = c(b.target), e = b.type, d = b.url, g = ~~b.total, h = ~~b.every, k = b.success,
                ...
                var t = b.find("div \x3e div"), q = b.find(".jsmodern-page-every"), z = b.find(".jsmodern-page-first"),
                    u = b.find(".jsmodern-page-last"), A = b.find(".jsmodern-page-prev"),
                ...
                var v = function (a) {
                    if (10 < n) {
                        ...
                        switch (a) {
                            case "next":
                                c > 42 * -b && t.stop().animate({marginLeft: c - 42 + "px"}, 100);
                                break;
                            case "prev":
                                0 > c && t.stop().animate({marginLeft: c + 42 + "px"}, 100);
                                break;
                            case "first":
                                t.stop().animate({marginLeft: 0}, 100);
                                break;
                            case "last":
                                t.stop().animate({marginLeft: 42 * -b + "px"}, 100)
                        }
                    }
                };
                v();
            ...
            var b = c("body").children(), f = c(window).width(), e = c(window).height();
            if (0 < b.length) {
                var d = b.first();
                d.addClass("jsmodern-fullpage-container");
                var g = a.axis || "y", b = a.background, h = a.time || 800, k = a.callback, m = d.children(),
                    l = m.length, n = [];
                ...
                var q = function (a) {
                    ...
                    if (document.head.classList) {
                        ...
                        if ("x" === g) d.css({transform: "translate3d(-" + f * a + "px, 0, 0)"}).on("transitionend", function () {
                            b()
                        });
                        if ("y" === g) d.css({transform: "translate3d(0, -" + e * a + "px, 0)"}).on("transitionend", function () {
                            b()
                        })
                    } else "x" === g && d.stop().animate({left: "-" + f * a + "px"}, h, "easeInOutQuart", function () {
                        b()
                    }), "y" === g && d.stop().animate({top: "-" + e * a + "px"}, h, "easeInOutQuart", function () {
                        b()
                    })
                };
            ...
            var b = decodeURI("%E6%9D%A5%E8%87%AA%E7%BD%91%E9%A1%B5%E7%9A%84%E6%B6%88%E6%81%AF"), f = c.noop,
                e = c.noop,
            ...
            if (!document.querySelector(".jsmodern-dialog-container")) {
                c("body").append(d);
                var g = c(".jsmodern-dialog-container"), h = g.find(".jsmodern-dialog"),
                    d = g.find(".jsmodern-dialog-cancel"), k = g.find(".jsmodern-dialog-sure"),
                    m = g.find(".jsmodern-dialog-content"), l = g.find(".jsmodern-dialog-title"), n = w.isMobile(),
                    p = arguments, t = p.length;
                ...
                h.outerHeight() > b && (h.height(b), m.css({overflowY: "scroll", height: b - l.height() - 53 + "px"}));
                n && (b = .85 * c(window).width() + "px", h.css({
                    width: b,
                    minWidth: b
                }).addClass("jsmodern-dialog-mobile"));
                g.stop().animate({opacity: 1}, 300);
                h.stop().animate({opacity: 1, top: n ? "50%" : "20px"}, 300);
                var q = function () {
                    h.stop().animate({top: n ? "43%" : "-20px", opacity: 0}, 300);
                    g.delay(50).animate({opacity: 0}, 300, function () {
                        g.remove()
                    })
                }, r = c.isPlainObject(a);
                k.click(function () {
